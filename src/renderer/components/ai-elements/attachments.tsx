...
export const Attachment = forwardRef<HTMLDivElement, AttachmentProps>(
  ({ data, onRemove, className, children, ...props }, ref): React.JSX.Element => {
...
export const AttachmentHoverCard = ({
  ...
  closeDelay = 0,
  ...props
}: AttachmentHoverCardProps): React.JSX.Element => (
...
export const AttachmentHoverCardContent = ({
  ...
  className,
  ...props
}: AttachmentHoverCardContentProps): React.JSX.Element => (
