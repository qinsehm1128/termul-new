  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // biome-ignore lint/suspicious/noDocumentCookie: intentional sidebar state persistence (shadcn/ui)
    ...
    return (
      <main
        ...
        className={cn(
          ...
          'peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.2))] md:peer-data-[variant=inset]:m-1 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-1 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-md',
          className
        )}
        {...props}
      />
